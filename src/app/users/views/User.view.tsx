        ...
        <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
          <div className="col-span-4 sm:col-span-3">
            <div className="bg-white shadow rounded-lg p-6">
              <div className="flex flex-col items-center">
                <img src={`https://robohash.org/${Math.round(Math.random())}?set=set2&size=180x180`}
                  className="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0"
                />


                <h1 className="text-xl font-bold">{data?.username}</h1>
                <h2 className="text-sm mb-3">{data?.email}</h2>
          ...
          <div className="col-span-4 sm:col-span-9">
            <div className="bg-white shadow rounded-lg p-6">
              ...
              <p className="text-gray-700 text-balance overflow-hidden">
                {data?.token}
              </p>
